...
import { SelfEmployedCalculatorForm } from "./SelfEmployedCalculatorForm"
import { SelfEmployedCalculatorResults } from "./SelfEmployedCalculatorResults"
...
export function SelfEmployedCalculator() {
  ...
  return (
    <section id="calculator" className="min-h-screen" style={{ backgroundColor: '#FAFAFF' }}>
      {/* Hero Section */}
      <div className="relative py-8 md:py-12 bg-gradient-to-r from-blue-600 to-indigo-600 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white">
          ...
          <h1 className="text-2xl md:text-4xl font-extrabold leading-tight mb-3 drop-shadow-lg">
            Калькулятор риска переквалификации самозанятых
          </h1>
          <p className="text-sm md:text-lg text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Оцените риск признания самозанятых вашими сотрудниками
          </p>
        </div>
      </div>
