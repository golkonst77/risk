...
**Дата запуска:** 11 октября 2025  
**Источник данных:** https://ausn.nalog.gov.ru/

**Расположение:** `D:\DATA\ausn-parser\`  
**Репозиторий основного проекта:** `D:\DATA\AUSN_V1\`

### Текущие данные:
- ✅ **69 регионов** (активные регионы с кодами от 01 до 99)
- ✅ **11 уполномоченных банков** (ИНН, ОГРН, название, дата включения в реестр)
...
## Детали парсинга данных

### 📍 Регионы (69 активных)

**Источник:** Первая таблица на странице https://ausn.nalog.gov.ru/  
...
**Алгоритм:**
- Поиск таблицы по заголовку "Код региона" или "Наименование"
- Фильтрация: код должен быть 1-2 цифры (регулярное выражение `/^\d{1,2}$/`)
- Исключение строк заголовков и неактивных регионов

### 🏦 Банки (11 уполномоченных)

**Источник:** Таблица "Перечень уполномоченных кредитных организаций"  
...
**Алгоритм:**
- Автоматический поиск таблицы по заголовкам "ИНН" и "Наименование"
- Фильтрация: ИНН должен содержать только цифры
- Логирование найденной таблицы для отладки

## Обновление данных

### Автоматическое обновление

Парсер настроен на автоматическое обновление каждое воскресенье в 03:00.
