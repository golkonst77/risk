...
## [1.0.14] - 2025-10-10 - Публикация репозитория

### Добавлено
- Инициализирован git-репозиторий локально и опубликован на GitHub: [golkonst77/AUSN](https://github.com/golkonst77/AUSN)
- Обновлен `.gitignore` (исключены служебные файлы `.cursor/`, `.cursorrules`)

### Безопасность
- Удалены артефакты с потенциальными секретами перед публикацией (push protection пройден)
